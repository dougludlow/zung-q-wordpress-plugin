<div ng-app="ZungApp" ng-controller="ZungController" ng-cloak class="zung ng-cloak">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <p>Most people with depression score between <strong>50</strong> and <strong>69</strong>. The highest possible score is <strong>80</strong><a href="#note-1"><sup>1</sup></a>.</p>
      <p>Your score: <strong>{{score()}}</strong> &nbsp;<span ng-class="range().stateClass" class="badge"><span ng-class="range().iconClass" class="glyphicon"></span> {{range().description}}</span>&nbsp;&nbsp;<a ng-href="{{mailto()}}" ng-show="checks === survey.length" class="send btn btn-xs btn-primary"><span class="glyphicon glyphicon-envelope"></span> Send Score</a></p>
    </div>
  </div>
